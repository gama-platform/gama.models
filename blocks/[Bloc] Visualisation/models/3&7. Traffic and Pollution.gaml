...
experiment "3.simple" {
	output {
		display carte3D type: 3d {
			species road aspect: asp_noir;
			species building refresh: false position: {0,0,0.3};
			species people position: {0,0,0.6};
		}
...
experiment "7.traffic" type: gui autorun: true{
	...
	output synchronized: true{
		display carte type: 3d axes: false background: rgb(50,50,50) fullscreen: true toolbar: true{
